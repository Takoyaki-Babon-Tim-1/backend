        ...
        <div class="w-full max-w-[440px] p-8 mx-auto">
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <input id="name" class="w-full p-2 px-4  bg-[#F4F4F4] rounded-[30px]" type="text" name="name"
                ...
                <div>
                    ...
                    <input id="email" class="w-full p-2 px-4  bg-[#F4F4F4] rounded-[30px]" type="email" name="email"
                ...
                <div>
                    ...
                    <input id="password" class="w-full p-2 px-4  bg-[#F4F4F4] rounded-[30px]" type="password" name="password"
                ...
                <div>
                    ...
                    <input id="password_confirmation" class="w-full p-2 px-4  bg-[#F4F4F4] rounded-[30px]" type="password"
